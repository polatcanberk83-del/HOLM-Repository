import{$t as e,Et as t,F as n,Ht as r,M as i,P as a,Pt as o,Ut as s,Vt as c,Xt as l,_ as u,a as d,an as f,d as p,et as m,f as h,ht as ee,i as te,it as g,m as _,n as v,nn as y,o as b,on as ne,p as re,r as ie,t as ae,tn as x,ut as S,w as C,wt as w,x as T,z as E,zt as D}from"./pageTransition-D7Nke-46.js";import{n as O,t as k}from"./holm new logo-rKkahY8u.js";import{t as A}from"./RoomEnvironment-PhzXZ9FT.js";var j=class extends g{constructor(e){super(e)}load(e,t,r,i){let a=this,o=new n(this.manager);o.setPath(this.path),o.setRequestHeader(this.requestHeader),o.setWithCredentials(this.withCredentials),o.load(e,function(e){let n=a.parse(JSON.parse(e));t&&t(n)},r,i)}parse(e){return new M(e)}},M=class{constructor(e){this.isFont=!0,this.type=`Font`,this.data=e}generateShapes(e,t=100,n=`ltr`){let r=[],i=N(e,t,this.data,n);for(let e=0,t=i.length;e<t;e++)r.push(...i[e].toShapes());return r}};function N(e,t,n,r){let i=Array.from(e),a=t/n.resolution,o=(n.boundingBox.yMax-n.boundingBox.yMin+n.underlineThickness)*a,s=[],c=0,l=0;(r==`rtl`||r==`tb`)&&i.reverse();for(let e=0;e<i.length;e++){let t=i[e];if(t===`
