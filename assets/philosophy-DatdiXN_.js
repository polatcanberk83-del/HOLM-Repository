import{$t as e,Bt as t,Dt as n,E as r,Et as i,Ft as a,Ht as o,L as s,Lt as c,N as l,S as u,Tt as d,Ut as f,V as p,a as m,an as h,b as g,d as _,dt as v,f as ee,gt as y,i as b,m as x,n as te,nn as S,o as ne,on as re,p as ie,r as C,rn as ae,t as oe,tn as w,tt as T,ut as se,x as ce}from"./pageTransition-Bs_UOWXO.js";import{t as le}from"./UnrealBloomPass-DpejatHY.js";import{n as ue,t as E}from"./OutputPass-DsP52OyW.js";var D=.16,O=.09,k=.18,A=typeof window<`u`&&(window.innerWidth<768||`ontouchstart`in window)?.28:.5,j=22,M=.3,N=.985,P=.9,F=.92,I=1.6,L=.72,R=1.4,z=`#000000`,B=`#02040c`,V=`#06183a`,H=`#123063`,U=`
varying vec2 vUv;
void main() {
  vUv = uv;
...
`;function W(e){return new S(parseInt(e.slice(1,3),16)/255,parseInt(e.slice(3,5),16)/255,parseInt(e.slice(5,7),16)/255)}var G=5.6,pe=1.85,me=4.4,he=.95,ge=.75,K=[{x:0,y:0,scale:1.2,side:null,hasText:!1},{x:.34,y:.03,scale:1,side:`left`,hasText:!0},{x:-.34,y:-.05,scale:1.24,side:`right`,hasText:!0},{x:0,y:.08,scale:.62,side:`left`,hasText:!0},{x:-.3,y:.06,scale:1.18,side:`right`,hasText:!0},{x:.28,y:-.04,scale:1.28,side:`left`,hasText:!0},{x:0,y:.02,scale:1.35,side:`center-below`,hasText:!0}],_e=1,ve=16773852,ye=9023716,be=12108014,xe=.012,q=1.05;`${xe.toFixed(4)}${q.toFixed(4)}${q.toFixed(4)}${.35.toFixed(4)}${320 .toFixed(1)}`;var J=[[`Some studios tell stories.`,`We work toward a single moment.`],[`The moment a rough idea holds still —`,`and becomes something finished.`],[`It is rare. It forms under pressure.`,`The way carbon becomes a diamond.`],[`So that is the shape we keep returning to.`,`Not decoration. A reminder of what we are after.`],[`Between sketch and masterpiece,`,`there is patience.`],[`Ready to create your moment.`]];function Se(e){return e.split(` `).map(e=>e?`<span class="holm-philosophy__word">${Array.from(e).map(e=>`<span class="holm-philosophy__char">${e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}</span>`).join(``)}</span>`:``).join(` `)}var Y=`Let's talk`,Ce=`/contact/`,we=class b{constructor({lenis:e}={}){this.lenis=e||null,this._reducedMotion=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,this._isMobile=window.innerWidth<768||`ontouchstart`in window,this.renderer=null,this.scene=null,this.camera=null,this.diamond=null,this.envMap=null,this._lights=[],this._heroPlane=null,this.container=null,this.canvas=null,this.blocks=[],this._rafId=null,this._active=!1,this._prevTime=0,this._scrollT=0,this._idleSpin=0,this._ctaEl=null,this._ctaMove=null,this._ctaLeave=null,this._ctaSetX=null,this._ctaSetY=null,this._ctaInnerSetX=null,this._ctaInnerSetY=null,this._targetPos=new S,this._targetScale=new S(1,1,1),this._targetTilt=0,this._pressure=0,this._mouseNdc=new w(-99,-99),this._mouseWorld=new S,this._mouseWorldSmooth=new S(999,999,999),this._invMat=new se,this._pointerActive=!1,this._elapsed=0,this._fluidQuadCam=null,this._fluidQuadScene=null,this._fluidQuadMesh=null,this._fluidMat=null,this._displayMat=null,this._fluidTargetA=null,this._fluidTargetB=null,this._displayTarget=null,this._fluidFrame=0,this._mousePx=new w(0,0),this._prevMousePx=new w(0,0),this._lastMouseMoveMs=0,this._onResize=this._onResize.bind(this),this._onLenisScroll=this._onLenisScroll.bind(this),this._onNativeScroll=this._onNativeScroll.bind(this),this._onPointerMove=this._onPointerMove.bind(this),this._observer=null}init(){this._createDOM(),this._createThree(),this._bindScroll(),this._bindResize(),this._bindPointer(),this._observeBlocks(),this._bindCtaMagnetic(),this._startLoop()}_bindPointer(){window.addEventListener(`pointermove`,this._onPointerMove,{passive:!0})}_onPointerMove(e){if(this._mouseNdc.set(e.clientX/window.innerWidth*2-1,-(e.clientY/window.innerHeight*2-1)),this._pointerActive=!0,this._fluidMat){window.innerWidth;let t=window.innerHeight,n=e.clientX*A,r=(t-e.clientY)*A;this._prevMousePx.copy(this._mousePx),this._mousePx.set(n,r),this._lastMouseMoveMs=performance.now(),this._fluidMat.uniforms.iMouse.value.set(this._mousePx.x,this._mousePx.y,this._prevMousePx.x,this._prevMousePx.y)}}destroy(){this._active=!1,this._rafId&&cancelAnimationFrame(this._rafId),window.removeEventListener(`resize`,this._onResize),window.removeEventListener(`pointermove`,this._onPointerMove),this.lenis&&this._lenisScrollBound?this.lenis.off(`scroll`,this._onLenisScroll):window.removeEventListener(`scroll`,this._onNativeScroll),this._observer&&this._observer.disconnect(),this._ctaMove&&window.removeEventListener(`mousemove`,this._ctaMove),this._ctaLeave&&window.removeEventListener(`mouseleave`,this._ctaLeave),this.diamond&&this.diamond.material.dispose(),this._heroPlane&&(this._heroPlane.geometry.dispose(),this._heroPlane.material.uniforms?.uTextMap?.value?.dispose(),this._heroPlane.material.dispose()),this.envMap&&this.envMap.dispose();for(let e of this._lights)this.scene?.remove(e);this._fluidTargetA?.dispose(),this._fluidTargetB?.dispose(),this._displayTarget?.dispose(),this._fluidMat?.dispose(),this._displayMat?.dispose(),this._fluidQuadMesh?.geometry?.dispose(),this.renderer&&(this.renderer.dispose(),this.renderer.forceContextLoss?.()),this.container?.parentNode&&this.container.parentNode.removeChild(this.container),this.renderer=this.scene=this.camera=null,this.diamond=this.envMap=null,this.container=this.canvas=null}_createDOM(){let e=document.createElement(`div`);e.className=`holm-philosophy`,this._reducedMotion&&e.classList.add(`is-reduced-motion`);let t=0;if(e.innerHTML=`
    ...
    `,document.body.appendChild(e),this.container=e,this.canvas=e.querySelector(`.holm-philosophy__canvas`),this.blocks=[...e.querySelectorAll(`.holm-philosophy__beat`)],this._beatEls=[],e.querySelectorAll(`[data-beat]`).forEach(e=>{let t=parseInt(e.dataset.beat,10);Number.isFinite(t)&&K[t]&&this._beatEls.push({el:e,beat:K[t]})}),!this._reducedMotion){let t=e.querySelectorAll(`.holm-philosophy__char`);_.set(t,{yPercent:115,opacity:0})}}_createThree(){this.renderer=new ie({canvas:this.canvas,antialias:!0,alpha:!1,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,this._isMobile?1:2)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=.55,this.renderer.outputColorSpace=t,this.scene=new o,this._initFluid(),this.scene.background=this._displayTarget.texture,this.camera=new d(36,window.innerWidth/window.innerHeight,.1,100),this.camera.position.set(0,0,G),this.camera.lookAt(0,0,0);let e=new ee(this.renderer),n=new ue;this.envMap=e.fromScene(n,.04).texture,e.dispose(),this.scene.environment=this.envMap,this.scene.environmentIntensity=pe,this._composer=new ne(this.renderer),this._composer.setPixelRatio(this.renderer.getPixelRatio()),this._composer.setSize(window.innerWidth,window.innerHeight),this._composer.addPass(new m(this.scene,this.camera)),this._isMobile||(this._bloom=new le(new w(window.innerWidth,window.innerHeight),.28,.35,.98),this._composer.addPass(this._bloom)),this._composer.addPass(new E),this._createDiamond(),this._createHeroPlane(),this._addLights()}_createHeroPlane(){let e=document.createElement(`canvas`);e.width=2560,e.height=640;let r=e.getContext(`2d`);r.fillStyle=`rgba(255, 255, 255, 1.0)`,r.font=`italic 300 480px 'Fraunces', 'Times New Roman', serif`,r.textAlign=`center`,r.textBaseline=`middle`,r.fillText(`philosophy`,e.width/2,e.height/2+30);let a=new u(e);a.colorSpace=t,a.minFilter=T,a.magFilter=T,a.anisotropy=this.renderer.capabilities.getMaxAnisotropy();let o=new f({vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,uniforms:{uTextMap:{value:a},uFluidMap:{value:this._displayTarget.texture},uTime:{value:0},uMouseUv:{value:new w(-2,-2)},uCursorFocus:{value:0},uOpacity:{value:1}},transparent:!0,depthWrite:!1}),s=G- -8,l=this.camera.fov*Math.PI/360,d=Math.tan(l)*s*this.camera.aspect,p=Math.max(d*2*1.15,20),m=p/(e.width/e.height),h=this._isMobile?[32,8]:[96,24],g=new n(p,m,h[0],h[1]);this._heroPlane=new v(g,o),this._heroPlane.position.z=-8,this._heroPlane.renderOrder=-1,this._heroPlaneSize={w:p,h:m,z:-8},this._heroPlaneMath=new i(new S(0,0,1),8),this._heroRaycaster=new c,this._heroHitPoint=new S,this.scene.add(this._heroPlane)}_initFluid(){let r=Math.max(2,Math.floor(window.innerWidth*A)),i=Math.max(2,Math.floor(window.innerHeight*A)),s={minFilter:T,magFilter:T,format:a,type:p,depthBuffer:!1,stencilBuffer:!1};this._fluidTargetA=new h(r,i,s),this._fluidTargetB=new h(r,i,s),this._displayTarget=new h(r,i,{...s,type:e}),this._fluidCurrent=this._fluidTargetA,this._fluidPrev=this._fluidTargetB,this._fluidMat=new f({vertexShader:U,fragmentShader:de,defines:{FLUID_ITER:this._isMobile?4:8},uniforms:{iTime:{value:0},iResolution:{value:new w(r,i)},iMouse:{value:new ae(0,0,0,0)},iFrame:{value:0},iPreviousFrame:{value:null},uBrushSize:{value:j},uBrushStrength:{value:M},uFluidDecay:{value:N},uTrailLength:{value:P},uStopDecay:{value:F}}}),this._displayMat=new f({vertexShader:U,fragmentShader:fe,uniforms:{iTime:{value:0},iResolution:{value:new w(r,i)},iFluid:{value:null},uDistortionAmount:{value:I},uColor1:{value:W(z)},uColor2:{value:W(B)},uColor3:{value:W(V)},uColor4:{value:W(H)},uColorIntensity:{value:L},uSoftness:{value:R}}}),this._fluidQuadCam=new ce,this._fluidQuadScene=new o,this._fluidQuadMesh=new v(new n(2,2),this._fluidMat),this._fluidQuadScene.add(this._fluidQuadMesh),this._displayTarget.texture.colorSpace=t}_stepFluid(e){if(!this._fluidMat)return;if(this._isMobile&&(this._fluidFrame&1)==1){this._fluidFrame++;return}performance.now()-this._lastMouseMoveMs>100&&this._fluidMat.uniforms.iMouse.value.set(0,0,0,0),this._fluidMat.uniforms.iTime.value=e,this._fluidMat.uniforms.iFrame.value=this._fluidFrame,this._fluidMat.uniforms.iPreviousFrame.value=this._fluidPrev.texture,this._fluidQuadMesh.material=this._fluidMat,this.renderer.setRenderTarget(this._fluidCurrent),this.renderer.clear(),this.renderer.render(this._fluidQuadScene,this._fluidQuadCam),this._displayMat.uniforms.iTime.value=e,this._displayMat.uniforms.iFluid.value=this._fluidCurrent.texture,this._fluidQuadMesh.material=this._displayMat,this.renderer.setRenderTarget(this._displayTarget),this.renderer.clear(),this.renderer.render(this._fluidQuadScene,this._fluidQuadCam),this.renderer.setRenderTarget(null);let t=this._fluidCurrent;this._fluidCurrent=this._fluidPrev,this._fluidPrev=t,this._fluidFrame++}_createDiamond(){let e=this._isMobile?24:48,t=b._getBrilliantGeometry(e),n=this._isMobile,i=new y({color:16777215,metalness:0,roughness:0,transmission:1,thickness:n?1.2:1.8,ior:2.417,attenuationDistance:6,attenuationColor:new r(16777215),envMapIntensity:n?1.7:2.2,iridescence:n?0:.35,iridescenceIOR:1.55,iridescenceThicknessRange:[400,900],clearcoat:+!n,clearcoatRoughness:0,transparent:!0,side:n?0:2});!n&&`dispersion`in i&&(i.dispersion=3.2),this.diamond=new v(t,i),this.diamond.rotation.x=-.18,this.scene.add(this.diamond)}static _getBrilliantGeometry(e){b._geomCache||=new Map;let t=b._geomCache.get(e);if(t)return t;let n=[],r=[],i=Math.PI/e,a=[[.62,0,0],[.62,.4,0],[.4,.7,i],[.08,1,0],[-.22,.88,i],[-.72,.42,0],[-1.08,0,0]],o=[];for(let[t,r,i]of a)if(o.push(n.length/3),r===0)n.push(0,t,0);else for(let a=0;a<e;a++){let o=a/e*Math.PI*2+i;n.push(Math.cos(o)*r,t,Math.sin(o)*r)}for(let t=0;t<a.length-1;t++){let[,n]=a[t],[,i]=a[t+1],s=o[t],c=o[t+1];if(n===0&&i>0)for(let t=0;t<e;t++){let n=(t+1)%e;r.push(s,c+t,c+n)}else if(n>0&&i===0)for(let t=0;t<e;t++){let n=(t+1)%e;r.push(s+t,s+n,c)}else for(let t=0;t<e;t++){let n=(t+1)%e;r.push(s+t,s+n,c+t),r.push(s+n,c+n,c+t)}}return t=new g,t.setAttribute(`position`,new s(n,3)),t.setIndex(r),t.scale(.92,1.06,.92),t.computeVertexNormals(),b._geomCache.set(e,t),t}_addLights(){let e=new l(ve,me);e.position.set(3.5,4,3.2),this.scene.add(e),this._lights.push(e);let t=new l(ye,he);t.position.set(-4,1,-2),this.scene.add(t),this._lights.push(t);let n=new l(be,ge);n.position.set(0,-3,-4),this.scene.add(n),this._lights.push(n);let r=new x(1185830,.35);this.scene.add(r),this._lights.push(r)}_bindScroll(){this.lenis&&typeof this.lenis.on==`function`?(this.lenis.on(`scroll`,this._onLenisScroll),this._lenisScrollBound=!0):window.addEventListener(`scroll`,this._onNativeScroll,{passive:!0})}_onLenisScroll({scroll:e,limit:t}){this._scrollT=t>0?Math.min(e/t,1):0}_onNativeScroll(){let e=document.documentElement.scrollHeight-window.innerHeight;this._scrollT=e>0?Math.min(window.scrollY/e,1):0}_bindResize(){window.addEventListener(`resize`,this._onResize)}_onResize(){let e=window.innerWidth,t=window.innerHeight;if(this.camera&&(this.camera.aspect=e/t,this.camera.updateProjectionMatrix()),this.renderer&&this.renderer.setSize(e,t),this._composer&&this._composer.setSize(e,t),this._bloom&&this._bloom.setSize(e,t),this._fluidTargetA&&this._fluidTargetB&&this._displayTarget){let n=Math.max(2,Math.floor(e*A)),r=Math.max(2,Math.floor(t*A));this._fluidTargetA.setSize(n,r),this._fluidTargetB.setSize(n,r),this._displayTarget.setSize(n,r),this._fluidMat.uniforms.iResolution.value.set(n,r),this._displayMat.uniforms.iResolution.value.set(n,r),this._fluidFrame=0}this._isMobile=e<768||`ontouchstart`in window}_observeBlocks(){this._observer=new IntersectionObserver(e=>{e.forEach(e=>{if(!e.isIntersecting||e.target.classList.contains(`is-revealed`))return;e.target.classList.add(`is-revealed`);let t=e.target.dataset.final===`true`?e.target.querySelector(`.holm-philosophy__cta`):null;if(this._reducedMotion){e.target.classList.add(`is-in`),t&&_.set(t,{opacity:1});return}let n=e.target.querySelectorAll(`.holm-philosophy__char`);if(_.to(n,{yPercent:0,opacity:1,duration:.85,stagger:.018,ease:`power3.out`}),t){let e=n.length*.018+.15;_.fromTo(t,{opacity:0,scale:.85},{opacity:1,scale:1,duration:.9,delay:e,ease:`power3.out`})}})},{threshold:.35,rootMargin:`0px 0px -8% 0px`}),this.blocks.forEach(e=>this._observer.observe(e))}_bindCtaMagnetic(){if(this._reducedMotion)return;let e=this.container.querySelector(`.holm-philosophy__cta`);e&&(this._ctaEl=e,_.set(e,{opacity:0,x:0,y:0}),this._ctaSetX=_.quickTo(e,`x`,{duration:.55,ease:`power3`}),this._ctaSetY=_.quickTo(e,`y`,{duration:.55,ease:`power3`}),this._ctaMove=t=>{let n=e.getBoundingClientRect(),r=n.left+n.width/2,i=n.top+n.height/2,a=t.clientX-r,o=t.clientY-i,s=Math.hypot(a,o),c=n.width*1.35;if(s>c){this._ctaSetX(0),this._ctaSetY(0),e.classList.remove(`is-magnetic`);return}let l=(1-s/c)*.4;this._ctaSetX(a*l),this._ctaSetY(o*l),e.classList.add(`is-magnetic`)},this._ctaLeave=()=>{this._ctaSetX(0),this._ctaSetY(0),e.classList.remove(`is-magnetic`)},window.addEventListener(`mousemove`,this._ctaMove,{passive:!0}),window.addEventListener(`mouseleave`,this._ctaLeave))}_computeBeatTarget(){if(!this._beatEls||this._beatEls.length===0)return{x:0,y:0,scale:1};let e=window.innerHeight,t=e/2,n=e*_e,r=0,i=0,a=0,o=0;for(let{el:e,beat:s}of this._beatEls){let c=e.getBoundingClientRect(),l=c.top+c.height/2,u=Math.abs(l-t),d=Math.max(0,1-u/n),f=d*d*(3-2*d);r+=f,i+=s.x*f,a+=s.y*f,o+=s.scale*f}if(r<.001){let e=0,n=1/0;this._beatEls.forEach(({el:r},i)=>{let a=r.getBoundingClientRect(),o=a.top+a.height/2,s=Math.abs(o-t);s<n&&(n=s,e=i)});let r=this._beatEls[e].beat;return{x:r.x,y:r.y,scale:r.scale}}return{x:i/r,y:a/r,scale:o/r}}_startLoop(){this._active=!0,this._prevTime=performance.now();let e=t=>{if(!this._active)return;let n=(t-this._prevTime)/1e3,r=Math.min(n,.05);this._prevTime=t,this._idleSpin+=D*r;let i=this._reducedMotion?{x:0,y:0,scale:1.2}:this._computeBeatTarget(),a=this.camera.fov*Math.PI/360,o=Math.tan(a)*G,s=o*this.camera.aspect,c=this._isMobile,l=i.x,u=i.y;this._targetPos.set(l*s,u*o,0);let d=1-(1-O)**(r*60);this.diamond.position.lerp(this._targetPos,d);let f=c?i.scale*.42:i.scale,p=this.diamond.scale.x+(f-this.diamond.scale.x)*d;if(this.diamond.scale.setScalar(p),this._heroPlane){let e=Math.max(0,1-this._scrollT*4),t=e*e*(3-2*e),n=this._heroPlane.material.uniforms;if(n.uOpacity.value=t,n.uTime.value=this._elapsed,this._heroPlane.visible=t>.005,this._heroPlane.visible&&this._pointerActive){this._heroRaycaster.setFromCamera(this._mouseNdc,this.camera);let e=this._heroRaycaster.ray.intersectPlane(this._heroPlaneMath,this._heroHitPoint);if(e){let{w:r,h:i}=this._heroPlaneSize,a=(e.x+r*.5)/r,o=1-(e.y+i*.5)/i;n.uMouseUv.value.set(a,o),n.uCursorFocus.value=t}}else n.uCursorFocus.value=0}let m=this._reducedMotion?-.18:-.18+Math.sin(this._scrollT*Math.PI)*k;this.diamond.rotation.y=this._idleSpin,this.diamond.rotation.x=m,this._elapsed+=r,this._stepFluid(this._elapsed),this._composer.render(),this._rafId=requestAnimationFrame(e)};this._rafId=requestAnimationFrame(e)}},X=new re(window.innerWidth<768||`ontouchstart`in window?{smoothTouch:!1,touchMultiplier:.75}:{duration:1.6,smoothWheel:!0,wheelMultiplier:.55,touchMultiplier:1.2,smoothTouch:!1});_.ticker.lagSmoothing(0);function Z(e){X.raf(e),requestAnimationFrame(Z)}requestAnimationFrame(Z);var Q=new b({lenis:X});Q.mount();var $=new we({lenis:X});$.init(),C(document),oe(),window.addEventListener(`load`,()=>{setTimeout(te,200)}),window.addEventListener(`pagehide`,()=>{$.destroy(),Q.destroy?.(),X.destroy?.()});